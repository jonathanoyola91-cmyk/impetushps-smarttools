...
urlpatterns = [
    ...
    path(
        "solicitar-precio-reparacion/<int:solicitud_id>/",
        solicitar_precio_reparacion,
        name="solicitar_precio_reparacion",
    ),
    path(
        "diagnostico-variador/",
        diagnostico_variador_view,
        name="diagnostico_variador",
    ),
    path(
        "diagnostico-variador/importar/",
        importar_diagnostico_variador_view,
        name="importar_diagnostico_variador",
    ),
]