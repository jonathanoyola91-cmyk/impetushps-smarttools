...
urlpatterns = [
    ...
    auth_views.PasswordResetView.as_view(
        template_name="cotizador/password_reset.html",
        email_template_name="cotizador/password_reset_email.html",
        subject_template_name="cotizador/password_reset_subject.txt",
...
path(
    ...
    auth_views.PasswordResetDoneView.as_view(
        template_name="cotizador/password_reset_done.html"
    ),
...
path(
    ...
    auth_views.PasswordResetConfirmView.as_view(
        template_name="cotizador/password_reset_confirm.html",
